...
public class SemaphoreTest {
    ...
    public void test1Pass() {
        ...
        assertEquals("green means GO", true, semaphore.canIGo());

        semaphore.changeState();
        assertEquals("Yellow means STOP", false, semaphore.canIGo());

        semaphore.changeState();
        assertEquals("Red means STOP", false, semaphore.canIGo());
