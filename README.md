...
4. Once the runtime starts, you can access the project at http://localhost:8080/coding-dojo-concurrency
...
```
docker run -p 8080:8080 coding-dojo-concurrency:${project.version}
```
Replace coding-dojo-concurrency:${project.version} with the actual image name and tag.
