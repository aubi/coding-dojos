...
Example:
curl -i -X POST -H "Content-Type: application/json"  -d '{"sourceId":719966,"time":81207.87613,"position":56,"temperature":46,"label":7097}' http://localhost:8080/myapp/api/data
